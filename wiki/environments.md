...
These [environment variables](#environment-variables) are available in most [operating systems](./operating-system#):

- [`PATH`](#path-environment-variable)

### `PATH` environment variable

`PATH` contains a list of [directories](./file-system.md#directory) separated by `:`. When you run a command in the [terminal](./vs-code.md#terminal), the system looks for the [program](./linux.md#program) in each directory listed in `PATH`, from left to right.
